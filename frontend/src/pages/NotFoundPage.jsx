  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-xl rounded-[2rem] border border-border-subtle bg-white p-10 text-center shadow-soft">
        ...
        <h1 className="mt-5 text-5xl font-semibold tracking-[-0.03em] text-text-primary">Page not found</h1>
        <p className="mt-4 text-lg leading-8 text-text-secondary">
          The page you requested does not exist in this workspace yet.
        </p>
        <Link
          to="/chat"
