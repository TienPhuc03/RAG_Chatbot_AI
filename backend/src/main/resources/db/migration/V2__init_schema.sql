...
CREATE TABLE chunks (
    ...
    CONSTRAINT fk_chunks_document FOREIGN KEY (documents_id) REFERENCES documents(documents_id) ON DELETE CASCADE
);
...
CREATE TABLE messages (
    ...
    CONSTRAINT fk_messages_conversation FOREIGN KEY (conversations_id) REFERENCES conversations(conversations_id) ON DELETE CASCADE
);
...
CREATE TABLE citations (
    ...
    CONSTRAINT fk_citations_message FOREIGN KEY (messages_id) REFERENCES messages(messages_id) ON DELETE CASCADE,
    CONSTRAINT fk_citations_chunk FOREIGN KEY (chunks_id) REFERENCES chunks(chunks_id) ON DELETE CASCADE
);
...
--thêm cột status vào bảng documents
--mặc định PENDING cho các document đã tồn tại
